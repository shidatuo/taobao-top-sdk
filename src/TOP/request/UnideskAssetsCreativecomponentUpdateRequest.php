...
/**
 * TOP API: taobao.unidesk.assets.creativecomponent.update request
 *
 * @author auto create
 * @since 1.0, 2022.08.31
 */
class UnideskAssetsCreativecomponentUpdateRequest
{
	/**
	 * 组件详细信息
	 **/
	...
	{
		return "taobao.unidesk.assets.creativecomponent.update";
	}
