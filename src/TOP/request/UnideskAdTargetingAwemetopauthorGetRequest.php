...
/**
 * TOP API: taobao.unidesk.ad.targeting.awemetopauthor.get request
 *
 * @author auto create
 * @since 1.0, 2022.08.31
 */
class UnideskAdTargetingAwemetopauthorGetRequest
{
	/**
	 * 查询入参
	 **/
	...
	{
		return "taobao.unidesk.ad.targeting.awemetopauthor.get";
	}
