<?php
/**
 * TOP API: taobao.unidesk.ad.targeting.behaviorinterestkeyword.get request
 * 
 * @author auto create
 * @since 1.0, 2022.08.31
 */
class UnideskAdTargetingBehaviorinterestkeywordGetRequest
{
	/** 
	 * 查询入参
	 **/
	...
	{
		return "taobao.unidesk.ad.targeting.behaviorinterestkeyword.get";
	}
